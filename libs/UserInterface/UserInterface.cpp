...
Command UserInterface::parseActionCommand(const char* command_string) const {
...
void splitLineToFloatArray(const char* command_string, double* arr, int size) {
	char delimiters[] = ",";
...
Command UserInterface::parseServoCommand(const char* command_string) const {
...
Command UserInterface::parsePositionCommand(const char* command_string) const {
	double position[N_DIMENSIONS];
	splitLineToFloatArray(command_string, &position[0], N_DIMENSIONS);
	struct Point point { position[0], position[1], position[2] };
...
Command UserInterface::parseInitializeCommand(const char* command_string) const {
...
Command UserInterface::parseSaveCommand(const char* command_string) const {
...
Command UserInterface::parseResetCommand(const char* command_string) const {
...
Command UserInterface::parseDeltaCommand(const char* command_string) const {
...
Command UserInterface::getNextMessage() {
	...
	getDataFromCommand(input_buffer);
